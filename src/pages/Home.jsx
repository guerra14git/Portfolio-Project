  ...
  return (
    <div className="pointer-events-auto relative z-10 flex min-h-[100svh] w-full justify-center px-4 pb-12 pt-28 sm:px-8">
      ...
      <div className="flex w-full max-w-[1300px] flex-col items-start gap-8 lg:flex-row">
        ...
        {/* left sidebar */}
        <aside className="w-full shrink-0 rounded-2xl border border-[#334155]/40 bg-[#020205]/60 p-6 shadow-[0_0_20px_rgba(0,0,0,0.4)] backdrop-blur-md lg:sticky lg:top-28 lg:w-[320px] lg:p-8">
          ...
          <div className="flex items-center lg:flex-col lg:text-center">
            ...
            <button 
              ...
              className="ml-auto flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-[#334155]/50 bg-[#1e293b]/40 text-cyan-400 transition-all duration-300 hover:bg-[#334155]/50 lg:hidden"
            >
              <svg 
          ...
          <div className={`grid transition-all duration-500 ease-in-out lg:mt-0 lg:grid-rows-[1fr] lg:opacity-100 ${isInfoExpanded ? 'mt-6 grid-rows-[1fr] opacity-100' : 'mt-0 grid-rows-[0fr] opacity-0'}`}>
            <div className="overflow-hidden">
              ...
              <div className="mb-6 flex justify-center lg:justify-center">
                <div className="rounded-md border border-[#1e293b]/50 px-3 py-1 lg:px-4 lg:py-1.5">
                  <p className="text-[10px] uppercase tracking-[0.1em] text-[#8ea0bf] lg:text-xs">Computer Science Engineer</p>
                </div>
              </div>
              ...
              <div className="mb-6 flex w-full flex-col gap-5 text-left">
                ...
                <div className="flex w-full items-center gap-4">
                  <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-[#334155]/50 bg-[#1e293b]/40 text-cyan-400 shadow-[0_4px_10px_rgba(0,0,0,0.3)]">
                    <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <div className="flex min-w-0 flex-col">
                    <span className="text-[10px] font-medium uppercase tracking-wider text-[#8ea0bf]">Email</span>
                ...
                <div className="flex w-full items-center gap-4">
                  ...
                  <div className="flex min-w-0 flex-col">
                    <span className="text-[10px] font-medium uppercase tracking-wider text-[#8ea0bf]">Location</span>
